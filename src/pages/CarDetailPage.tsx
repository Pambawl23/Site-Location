...
{/*import { useParams, Link } from 'react-router-dom';
import { motion } from 'framer-motion';
import { ArrowLeft, Users, Settings, Wind, Briefcase } from 'lucide-react';
import { cars } from '../images_voitures';
...
export function CarDetailPage() {
    ...
    return (
      <main className="pt-32 pb-20 min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/location" className="text-brand-blue hover:underline flex items-center justify-center gap-2">
            <ArrowLeft size={16} />
            Retour au catalogue
          </Link>
        </div>
  ...
  const whatsappMessage = `Bonjour, je souhaite réserver :\n\n🚗 ${car.name}\n💰 ${car.priceDay}/jour\n👥 ${car.seats} places\n⚙️ ${car.transmission}\n❄️ ${car.ac ? 'Climatisé' : 'Non climatisé'}`;
  const whatsappURL = 'https://wa.me/221770417603?text=' + encodeURIComponent(whatsappMessage);

  return (
    <main className="pt-24 pb-20 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">

        <Link to="/location" className="inline-flex items-center gap-2 text-gray-500 hover:text-brand-blue transition-colors mb-8 font-medium">
          <ArrowLeft size={20} />
          Retour au catalogue
        </Link>
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
            <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 mb-8">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 text-lg mb-8 leading-relaxed">{car.desc}</p>

                <h3 className="font-bold text-gray-900 mb-4">Caractéristiques</h3>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
                  <div className="bg-gray-50 p-4 rounded-xl flex flex-col items-center text-center">
                    <Users size={24} className="text-brand-blue mb-2" />
                    <span className="text-sm font-medium text-gray-900">{car.seats} Places</span>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-xl flex flex-col items-center text-center">
                    <Settings size={24} className="text-brand-blue mb-2" />
                  ...
                  <div className="bg-gray-50 p-4 rounded-xl flex flex-col items-center text-center">
                    <Wind size={24} className="text-brand-blue mb-2" />
                    <span className="text-sm font-medium text-gray-900">{car.ac ? 'Climatisé' : 'Non climatisé'}</span>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-xl flex flex-col items-center text-center">
                    <Briefcase size={24} className="text-brand-blue mb-2" />
                    <span className="text-sm font-medium text-gray-900">Bagages</span>
                  </div>
                </div>
                ...
                <div className="bg-brand-blue/5 rounded-xl p-6 border border-brand-blue/10">
                  <div className="flex justify-between items-center py-3 border-b border-brand-blue/10">
                    ...
                    <span className="font-bold text-brand-blue text-lg">{car.priceDay}</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-brand-blue/10">
                    <span className="text-gray-600">Par semaine</span>
                    <span className="font-bold text-brand-blue text-lg">Sur devis</span>
                  </div>
                  <div className="flex justify-between items-center py-3">
                    <span className="text-gray-600">Par mois</span>
                    <span className="font-bold text-brand-blue text-lg">{car.priceMonth}</span>
                  </div>
                  <p className="text-xs text-gray-500 mt-4 text-center">
                    * Les tarifs peuvent varier selon la saison et la durée exacte.
                  </p>
                </div>
              </div>
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
              ...
              <div className="flex items-center gap-4 mb-6 p-4 bg-gray-50 rounded-2xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {car.seats} places · {car.transmission} · {car.ac ? 'Climatisé' : 'Non climatisé'}
                  </p>
                  <p className="text-brand-blue font-bold mt-1">{car.priceDay}/jour</p>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-4 px-6 bg-green-500 hover:bg-green-600 text-white font-bold rounded-2xl transition-colors text-lg cursor-pointer">
...
export function CarDetailPage() {
  ...
  const whatsappURL =
    'whatsapp://send?phone=221770417603&text=' +
    ...
    <main className="pt-24 pb-20 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          {/* Droite : Récapitulatif + Réservation */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 sticky top-28">
              ...
              <p className="text-gray-600 text-sm mb-8">
                ...
                WhatsApp avec toutes les informations du véhicule pour confirmer
                votre réservation.
              </p>
              ...
              <p className="text-xs text-gray-400 text-center mt-4">
                Le lien de ce véhicule sera inclus dans le message WhatsApp
                pour que nous puissions voir l'article concerné.
              </p>
