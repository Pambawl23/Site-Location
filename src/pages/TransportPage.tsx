      ...
      <div className="relative py-20 lg:py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <motion.p
            ...
            className="text-xl text-gray-300 max-w-2xl mx-auto">
            Découvrez nos trajets réguliers. Confort, sécurité et ponctualité garantis.
          </motion.p>
        </div>
      </div>
            ...
            <motion.div
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="p-6 md:p-8 flex-grow border-b md:border-b-0 md:border-r border-gray-100">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="flex-1">
                      <p className="text-sm text-gray-500 font-medium mb-1">Départ</p>
                      <h3 className="text-2xl font-bold text-brand-blue">{trip.from}</h3>
                    </div>
                    <div className="px-4 flex flex-col items-center text-gray-300">
                      <ArrowRight size={24} className="text-accent mb-1" />
                      <span className="text-xs font-medium text-gray-500">{trip.duration}</span>
                    </div>
                    <div className="flex-1 text-right">
                      <p className="text-sm text-gray-500 font-medium mb-1">Arrivée</p>
                      <h3 className="text-2xl font-bold text-brand-blue">{trip.to}</h3>
                    </div>
                  </div>
                ...
                <div className="p-6 md:p-8 md:w-72 flex flex-col justify-center bg-gray-50/50">
                  ...
                  {/* Récapitulatif mini */}
                  <div className="bg-white rounded-xl p-3 border border-gray-100 mb-4 text-xs text-gray-500 space-y-1">
                    <p>Trajet : <span className="font-semibold text-gray-700">{trip.from} → {trip.to}</span></p>
                    <p>Durée : <span className="font-semibold text-gray-700">{trip.duration}</span></p>
                    <p>Départ : <span className="font-semibold text-gray-700">{trip.departure}</span></p>
                  </div>

                  {/* Bouton WhatsApp */}
                  <button
                    onClick={() => window.open(buildWhatsappURL(trip), '_blank')}
                    className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-green-500 hover:bg-green-600 text-white font-bold rounded-xl transition-colors cursor-pointer">
                    Réserver
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 32 32"
